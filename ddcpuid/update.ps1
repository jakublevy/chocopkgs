...
function global:au_GetLatest {
    ...
    @{
        Version      = $version
        Url32        = "https://github.com/dd86k/ddcpuid/releases/download/v$version/ddcpuid-$version-windows-msvc-x86.zip"
        Url64        = "https://github.com/dd86k/ddcpuid/releases/download/v$version/ddcpuid-$version-windows-msvc-x86_64.zip"
