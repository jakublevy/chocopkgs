...
function global:au_GetLatest {
    $download_page = Invoke-WebRequest -UseBasicParsing -Uri 'https://github.com/dd86k/ggf/releases'
    $relative_url  = $download_page.links | Where-Object href -match '/dd86k/ggf/releases/download/v\d+\.\d+(\.\d+)*/ggf-win64\.zip' | Select-Object -First 1 -expand href
