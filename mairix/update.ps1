...
function global:au_GetLatest {
    ...
    $relative_urls  = $download_page.links | ? href -match "mairix-\d+\.\d+(\.\d+)*-w32-bin\.zip/download" | Select-Object -exp href
    ...
    @{
        Version  = $version
        Url32    = "https://sourceforge.net/projects/ezwinports/files/mairix-$version-w32-bin.zip/download"
    }
}
