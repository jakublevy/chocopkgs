**Note:** This package installs a version compiled with MSVC. Version compiled with MinGW is available as a [gprolog-mingw](https://community.chocolatey.org/packages/gprolog-mingw) package.
