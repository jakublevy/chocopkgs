...
function global:au_GetLatest {
    $download_page = Invoke-WebRequest -UseBasicParsing -Uri 'https://github.com/shenwei356/brename/releases'
    $relative_url  = $download_page.links | Where-Object href -match '/shenwei356/brename/releases/download/v\d+\.\d+(\.\d+)*/brename_windows_amd64\.exe\.tar\.gz' | Select-Object -First 1 -expand href
