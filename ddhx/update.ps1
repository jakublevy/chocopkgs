...
function global:au_GetLatest {
    ...
    $relative_url  = $download_page.links | Where-Object href -match '/dd86k/ddhx/releases/download/v\d+\.\d+(\.\d+)*/ddhx-\d+\.\d+(\.\d+)*-windows-msvc-x86_64\.zip' | Select-Object -First 1 -expand href
