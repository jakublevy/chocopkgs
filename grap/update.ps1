...
function global:au_GetLatest {
    ...
    $relative_urls  = $download_page.links | ? href -match "grap-\d+\.\d+(\.\d+)*-win32-bin\.zip/download" | Select-Object -exp href
    ...
    @{
        Version  = $version
        Url32    = "https://sourceforge.net/projects/ezwinports/files/grap-$version-win32-bin.zip"
    }
}
